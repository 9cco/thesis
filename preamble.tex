...
\newfontfamily\prefixFont[Ligatures=TeX]{URW Classico}%
...
\renewcommand*{\chapterformat}{%
    \parbox[c]{\textwidth}{%
        \savebox{\thechapternumber}{\,\color{gray}\scalebox{2.5}{\thechapter\autodot}} % Definition of box of the chapter number.
        \savebox{\chapterPrefix}{{\fontfamily{cmm}\fontshape{n}\selectfont\Large \chapapp}{\fontfamily{cmtt}\fontshape{n}\selectfont\Large apt}\enskip} % Definition of box containing "Chapter" text.
...
\setlength{\chapterVSpace}{2em}
\renewcommand*{\chapterlinesformat}[3]{%
    \parbox[b]{\textwidth}{#2}\par\vspace{\chapterVSpace}%
    #3\par%
}
