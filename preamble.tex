...
%\usepackage{tocstyle}   % This package is depricated
...
\usepackage{scrlayer-scrpage}           % Enables header customization
% Disable headers
%\pagestyle{plain}
% Enable headers
...
% Restore title of inbook references.
\PassOptionsToPackage{intitle=true}{biblatex}
...
\usepackage[version=4]{mhchem}     % Proper formatting of chemicals
...
% Acronyms
%\makeglossaries             % Removed since we won't print the glossery
\setacronymstyle{long-short}
\def\ac{\gls*}
\newacronym{mcmc}{MCMC}{Markov-Chain Monte-Carlo}
\newacronym{mc}{MC}{Monte-Carlo}
\newacronym{mcs}{MCS}{Monte-Carlo sweep}
\newacronym{mh}{MH}{Metropolis-Hastings}
\newacronym{pt}{PT}{parallel tempering}
\newacronym{gl}{GL}{Ginzburg-Landau}
\newacronym{ir}{IR}{irreducible representation}
