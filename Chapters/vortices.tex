...
In the type of superconductor described above, the winding numbers $n_+$ and $n_-$ fully determine the structure of possible vorticies. In the following we will use the
...
% it features spontaneuously broken time-reversal symmetry. In terms of the superconducting components, this means that the state can be written in terms of a dominant
...
% amplitude except at topological defects such as vorticies
